...
// import ArrowLaptop from '../../assets/figma/arrow.png'
...
export const assetsToStore = {
  ...
  FireGif, ContactBase, ScrollGif, ScrollDialog, projectModalBack, projectModal,
  VideoFlyMate, VideoPokemon, pokemonLogo, flymateLogo, logoLoading, buttonPokemonWeb,
